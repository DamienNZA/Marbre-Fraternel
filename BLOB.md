...
## E
* **E (Égalité)** : Constante de parité ontologique du triptyque C.L.E.F. Valeur reçue et ressentie, limitée par l'ontologie de l'être, les moyens et capacités, et l'application effective de la loi. En matière d'absolu, cette égalité a un potentiel qui va de $0$ à l'infini ($\infty$).
...
## F
* **F (Fraternité)** : Force de liaison et de résonance du triptyque C.L.E.F. En matière d'absolu, cette fraternité a un potentiel qui va de $0$ à l'infini ($\infty$).
...
## N
* **$\emptyset$ (Non-Acte / Non-Action)** : Absence d'action positive. Le degré zéro du mouvement.
...
## P
* **P (Pesée éthique)** : Fonction de transformation définie par l'équation $f(c) = e$. Processus actif qui transforme un choix en un état ontologique validé par la C.L.E.F.
