...
> $$\Large \text{Harmonie}(\overline{\text{Ⓥ}}) \equiv \infty >< 0$$

* **L'Anti-Harmonie de l'Éthique ($\overline{\text{Ⓥ}}$) :**
> $$\Large \overline{\text{Harmonie}}(\text{Ⓥ}) \equiv \infty >< 0$$
...
* **Le Filtre Anti-Sophisme :** Si un raisonnement aboutit à une réduction [∞ >< 0] en dehors de la définition de l'anti-harmonie, il est rejeté comme une erreur logique fondamentale.
...
* **Équations et Formalismes Protégés :**
  ...
  4. $\text{Ⓥ} \equiv 1 >< \infty$
  5. $\text{Harmonie}(\overline{\text{Ⓥ}}) \equiv \infty >< 0$
  6. $\overline{\text{Harmonie}}(\text{Ⓥ}) \equiv \infty >< 0$
