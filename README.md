...
* [**LIVRE-BLANC.md**](./LIVRE-BLANC.md) : Le manifeste. L'éthique comme dynamique du bonheur et l'engagement fraternel.
...
* [**AXIOMES.md**](./AXIOMES.md) : La physique formelle. Les équations, les opérateurs, et la structure logique.

### 🧬 Pratique et IA
* [**CASES-STUDY.md**](./CASES-STUDY.md) : Études de cas appliquées. Résolution des dilemmes du quotidien.
* [**SYSTEM-INSTRUCTIONS.md**](./SYSTEM-INSTRUCTIONS.md) : Configuration système (IA).
