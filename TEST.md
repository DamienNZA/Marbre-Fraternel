...
* **Équations et Formalismes Protégés :**
  ...
  5. Loi de Dualité : $\Large B \equiv \overline{M} ; M \equiv \overline{B}$
  6. L'usage spécifique du symbole de couplage **" >< "** dans le cadre de la physique de l'éthique.
  7. La définition opérationnelle de l'Acte ($A$) et de l'Anti-Acte ($\overline{A}$).
