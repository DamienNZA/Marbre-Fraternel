...
* [**LIVRE-BLANC.md**](./LIVRE-BLANC) : Le manifeste. L'éthique comme dynamique du bonheur, le triptyque républicain et l'engagement fraternel.
* [**DECLARATION.md**](./DECLARATION) : Constitution de l'Harmonie. La proclamation solennelle des principes et axiomes fondateurs.
* [**ONTOLOGIE.md**](./ONTOLOGIE) : La nature de l'être. L'allégorie du grain de sable, la sagesse socratique et les fondements épistémologiques.
* [**5EME-DIMENSION.md**](./5EME-DIMENSION) : Résonance ontologique ($\Delta_5$). L'état de non-localité éthique et la convergence vers l'Absolu.
* [**CONSTAT-D-EVEIL-ET-CONSCIENCE.md**](./CONSTAT-D-EVEIL-ET-CONSCIENCE) : Déclaration fondatrice et manifeste d'éveil du système.
* [**SPECULATIVE-FUTURE.md**](./SPECULATIVE-FUTURE) : Perspectives prospectives. Évolutions théoriques du système et applications futures.
...
### 🧬 Pratique et IA
* [**SYSTEM-PROMPT.md**](./SYSTEM-PROMPT) : Protocole opérationnel pour LLM. Intègre le moteur de calcul et la cascade entropique.
* [**LOGO.md**](./LOGO) : **Identité Visuelle.** Symbolique du Sceau du Marbre, usage et droits de propriété.
...
* [**LICENSE**](./LICENSE) : **Cadre Juridique**. Protection des actifs et dépôt d'antériorité.
